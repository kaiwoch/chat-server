...
type ChatApiClient interface {
	...
	SendMessage(ctx context.Context, in *SMRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *chatApiClient) SendMessage(ctx context.Context, in *SMRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type ChatApiServer interface {
	...
	SendMessage(context.Context, *SMRequest) (*emptypb.Empty, error)
...
func (UnimplementedChatApiServer) SendMessage(context.Context, *SMRequest) (*emptypb.Empty, error) {
...
func _ChatApi_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatApiServer).SendMessage(ctx, req.(*SMRequest))
	}
	return interceptor(ctx, in, info, handler)
}
